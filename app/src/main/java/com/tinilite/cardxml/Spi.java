...
public class Spi {
   ...
   public static byte[] generateSpiCode(String pLine){
   ...
   public static String spicodeToHex (byte[] pSpiCode){
        ...
        for (int i = 0; i < pSpiCode.length; i ++ ){
            ...
            //returnval = returnval + Integer.toUnsignedString ( pSpiCode[i], 16);

            returnval = returnval + StringUtilities.byteToHex(pSpiCode[i]);
            Log.d(TAG, "spicodeToHex: SpiCode[" + i + "]=" + pSpiCode[i] + " ret =  " + returnval);
        }
        returnval = returnval.toUpperCase();
        return returnval;
    }

    public static String spicodeToBin (byte[] pSpiCode){
        //for human viewing NOT for send over spi
        //the values sent over spi bare byte values
        //this function converts to hex string for human viewing
        String returnval = "";
        for (int i = 0; i < pSpiCode.length; i ++ ){
            ...
            returnval = returnval + StringUtilities.byteToBin(pSpiCode[i]);
            Log.d(TAG, "spicodeToBin: SpiCode[" + i + "]=" + pSpiCode[i] + " ret =  " + returnval);
        }
        returnval = returnval.toUpperCase();
        return returnval;
    }
